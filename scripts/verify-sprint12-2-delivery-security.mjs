...
if (!Array.isArray(wranglerConfig.triggers?.crons) || wranglerConfig.triggers.crons.length !== 0) {
  throw new Error("Sprint 12.2 security assertion failed: Cloudflare Cron Triggers remain disabled");
}
